 ...
 * estados, persiste e faz broadcast do estado novo para a HOME e para a
 * sidebar de reunião que estiver aberta.
 *
...
function broadcast(): void {
  ...
  // Páginas da extensão (a HOME, a página de documento):
