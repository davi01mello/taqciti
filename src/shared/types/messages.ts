...
const uiMessages = z.discriminatedUnion('type', [
  ...
  /** "Continuar fluxo": abre src/document numa aba nova pra essa reunião.
   *  Sempre por mensagem — o painel no Meet roda como content script e não
   *  tem acesso a chrome.tabs, então o background sempre faz essa parte. */
